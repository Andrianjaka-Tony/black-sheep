...
export function Escape() {
  return (
    <div className="text-white bg-green-1 px-6 md:px-20 lg:px-40 py-20 lg:py-40 w-screen flex flex-col items-center">
      ...
      <p className="mt-8 flex items-center font-cg text-xl md:text-2xl lg:text-3xl italic text-center">
      ...
      <p className="mt-16 flex items-center font-c text-xl md:text-2xl lg:text-3xl italic opacity-50 text-center">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
        ...
        <p className="text-yellow-1 flex items-center font-c text-xl md:text-2xl italic opacity-50">
