...
export function BreakTheStatic() {
  ...
  return (
    <div className="bg-white-1 px-6 md:px-8 py-6 md:py-8 xl:py-20 w-screen flex flex-col">
      <div className="mx-auto w-full max-w-6xl flex flex-col xl:flex-row items-center gap-10 xl:gap-0">
        {/* left: text */}
        <div className="w-full xl:w-1/2 flex flex-col md:items-center md:text-center xl:items-start xl:text-left">
          ...
          <div className="bg-yellow-1 px-5 py-3 mt-6 w-fit font-ws text-green-2 text-sm md:text-base font-bold tracking-tight rounded -rotate-2">
            ...
            <span className="hidden xl:inline">
              ...
              <br />A community that gets it. — Welcome to Open Air Pole Camp.
            </span>
          </div>
          ...
          <Button className="mt-8 bg-green-2 hover:shadow-lg hover:shadow-green-2/40">
            ...
            <ArrowRight
              className="h-3 w-3 md:h-3.5 md:w-3.5 xl:h-4 xl:w-4 text-yellow-1 transition-transform duration-200 group-hover:translate-x-1"
              strokeWidth={3}
            />
          </Button>
        </div>
        ...
        <div
          className="relative xl:ml-auto w-3/5 sm:w-2/5 md:w-1/3 xl:w-3/10 mx-auto xl:mx-0 translate-y-8"
