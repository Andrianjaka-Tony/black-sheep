...
export function Different() {
  return (
    <div className="bg-white-1 text-green-1 px-6 md:px-8 py-8 md:py-12 lg:py-20 w-screen flex flex-col items-center">
      <div className="mx-auto w-full max-w-6xl flex flex-col items-center">
        ...
        <div className="mt-12 bg-green-1/70 w-full md:w-4/5 lg:w-2/3 aspect-video rounded" />
        ...
        <div className="mt-16 md:mt-24 lg:mt-32 w-full flex flex-col md:flex-row justify-between items-start gap-10 md:gap-8">
          ...
          <div className="w-full md:w-1/2 lg:w-5/12 flex flex-col gap-6 text-brown-1">
            ...
            <div className="py-3 px-4 pr-10 w-fit bg-yellow-1 flex flex-col gap-1.5 rounded-sm shadow-lg -rotate-2 text-sm">
          ...
          >
            <div className="absolute bottom-4 right-1/8 w-full h-full bg-[#CC9C6B] scale-80 rounded shadow-lg rotate-8" />
            <div
              id="film-challenge"
              className="absolute overflow-hidden -top-4 right-4 w-full h-full bg-[#7CB5A5] rounded shadow-lg flex items-center justify-center text-white font-c text-2xl tracking-tight scale-75 -rotate-6 md:-top-4 md:right-4 md:scale-90 md:-rotate-6 lg:scale-90 lg:top-0 lg:right-95/100 lg:rotate-0 animate-floating-delayed"
            >
              <img
            ...
            <div className="absolute top-0 left-0 w-full h-full bg-green-2 scale-80 rounded shadow-lg flex flex-col items-center justify-center font-c tracking-tight animate-floating-slow">
              <p className="font-ws text-base text-white tracking-tight uppercase">
                Your soundtrack
              </p>
        ...
        <div className="mt-16 md:mt-24 lg:mt-32 w-full flex flex-col lg:flex-row gap-6">
          <div className="bg-green-1/90 flex-1 rounded-md p-8 md:p-10 lg:p-16">
          ...
          <div
            id="bonding"
            className="bg-white lg:w-[38%] rounded-md py-8 md:py-10 lg:py-16 px-8 md:px-10 shadow-lg"
          >
            ...
            <div className="text-green-1 mt-8 flex flex-col gap-3 font-i tracking-tight text-sm md:text-base">
              ...
              <div className="flex gap-2 items-start">
                ...
                <span>
                  ...
                  <span className="opacity-40 italic">(no phones moment)</span>
                </span>
              </div>
              <div className="flex gap-2 items-start">
                <ArrowRight className="h-4 w-4 mt-0.5 shrink-0" />
              ...
              <p className="mt-2 font-c text-lg animate-floating-delayed">
